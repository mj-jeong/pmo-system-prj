...
export interface NarrativeResult {
  ...
  markdown: string;
  /** Token usage reported by the provider. Zero-valued for mock/fallback. */
  usage: LlmUsageInfo;
  /** Whether this result was generated by the fallback template engine (not LLM). */
  isFallback: boolean;
  /** Reason for fallback (LLM error message), only set when isFallback is true. */
