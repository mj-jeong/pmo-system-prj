...
export const ERROR_CODES = {
  ...
  // Email Verification
  EMAIL_VERIFICATION_NOT_FOUND: "EMAIL_VERIFICATION_NOT_FOUND", // 발송 이력 없음
  EMAIL_VERIFICATION_EXPIRED: "EMAIL_VERIFICATION_EXPIRED",     // 10분 만료
  EMAIL_VERIFICATION_INVALID: "EMAIL_VERIFICATION_INVALID",     // 코드 불일치
} as const;
...
export const ERROR_STATUS_MAP: Record<string, number> = {
  ...
  [ERROR_CODES.EMAIL_VERIFICATION_NOT_FOUND]: 404,
  [ERROR_CODES.EMAIL_VERIFICATION_EXPIRED]: 410,
  [ERROR_CODES.EMAIL_VERIFICATION_INVALID]: 400,
};
